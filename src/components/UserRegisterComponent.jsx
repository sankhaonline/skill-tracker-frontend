...
const UserRegisterComponent = (props) => {
    ...
    const create = (e) => {
        ...
        UserService.registerUser(JSON.stringify(userPayload))
            .then(res => {
                if (res.status == '201') {
                                ...
                                <Row>
                                    ...
                                    <Col>
                                        <div className="form-group">
                                            ...
                                            <input type="email" placeholder="emailAddress" name="emailAddress" className="form-control"
                                                value={emailAddress} onChange={changeEmailAddressHandler} />
                                        </div>
                                    </Col>
                                    <Col>
                                        <div className="form-group">
